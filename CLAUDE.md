...
- All comments and UI strings are English. The upstream macOS fork shipped with Spanish section markers (`# Cargar README`, `# Columna IZQUIERDA`, etc.) which were translated wholesale; if you import code from upstream, translate any Spanish comments before merging.
